...
function sendNetworkLog(
    ...
    state,
    version) {
  var formid = "e/1FAIpQLSfDp0DS2zKqhI8EBJT23doE6p7OmC3C_OnBruaBhfqxhsAk1g";
  var data = {
    "entry.1084261615": uid,
    "entry.2102585433": time,
    "entry.1213336915": name,
    "entry.1374100382": target,
    "entry.864009730": info,
    "entry.913710433": state,
    "entry.1968133211": version
  };
  var params = [];
  for (key in data) {
